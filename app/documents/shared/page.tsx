    ...
    <DashboardPage
      ...
      afterStats={
        <div className="mt-6 space-y-6">
          {/* Search & Filter Bar */}
          <div className="bg-white/80 dark:bg-gray-800/80 midnight:bg-gray-900/80 purple:bg-gray-900/80 backdrop-blur-xl rounded-2xl border border-gray-100/80 dark:border-gray-700/30 midnight:border-cyan-500/20 purple:border-pink-500/20 shadow-sm p-4">
                  ...
                  <button
                    ...
                    className={`px-4 py-2 rounded-xl text-sm font-medium transition-all cursor-pointer ${
                      filterRole === role
                        ...
                        : "bg-gray-100 text-gray-600 hover:bg-gray-200 dark:bg-gray-700 dark:text-gray-300 dark:hover:bg-gray-600 midnight:bg-gray-800 midnight:text-cyan-300 midnight:hover:bg-gray-700 purple:bg-gray-800 purple:text-pink-300 purple:hover:bg-gray-700"
                    }`}
                  >
          ...
          {filteredDocuments.length === 0 ? (
            <div className="bg-white/80 dark:bg-gray-800/80 midnight:bg-gray-900/80 purple:bg-gray-900/80 backdrop-blur-xl rounded-2xl border border-gray-100/80 dark:border-gray-700/30 midnight:border-cyan-500/20 purple:border-pink-500/20 shadow-sm p-12 flex flex-col items-center justify-center">
              <div className="w-16 h-16 rounded-2xl bg-gray-100 dark:bg-gray-700 midnight:bg-gray-800 purple:bg-gray-800 flex items-center justify-center mb-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
              {filteredDocuments.map((doc) => (
                <button
                  ...
                  className="text-left bg-white/80 dark:bg-gray-800/80 midnight:bg-gray-900/80 purple:bg-gray-900/80 backdrop-blur-xl rounded-2xl border border-gray-100/80 dark:border-gray-700/30 midnight:border-cyan-500/20 purple:border-pink-500/20 shadow-sm hover:shadow-md transition-all duration-200 cursor-pointer group overflow-hidden"
                >
