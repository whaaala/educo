    ...
    <MainLayout>
      <div className="max-w-[1200px] mx-auto">
        ...
        <div className="flex items-center gap-4 mb-6">
          ...
          <div>
            <h1 className="text-[20px] font-bold text-gray-900 dark:text-white midnight:text-cyan-50 purple:text-pink-50">Template Gallery</h1>
            <p className="text-[13px] text-gray-500 dark:text-gray-400 midnight:text-cyan-300 purple:text-pink-300">{DOC_TEMPLATES.length} templates across {TEMPLATE_CATEGORIES.length} categories</p>
          </div>
        </div>
        ...
        <div className="flex flex-col sm:flex-row gap-3 mb-6">
          <div className="relative flex-1">
            ...
            <input
              ...
              className="w-full pl-10 pr-4 py-2.5 rounded-xl border border-gray-200 dark:border-gray-700 midnight:border-cyan-500/20 purple:border-pink-500/20 bg-white dark:bg-[#0f1115] midnight:bg-[#0a0e27] purple:bg-[#1a0b2e] text-[13px] text-gray-800 dark:text-gray-200 midnight:text-cyan-100 purple:text-pink-100 focus:outline-none focus:ring-2 focus:ring-blue-500/30 focus:border-blue-400 transition-all"
            />
          </div>
          <div className="flex gap-2 flex-wrap">
            <button
              onClick={() => { setActiveCategory(null); setSearchQuery(""); }}
              className={`px-3 py-1.5 rounded-lg text-[12px] font-medium transition-colors cursor-pointer ${!activeCategory && !searchQuery ? "bg-blue-500 text-white" : "bg-gray-100 dark:bg-[#1a1d24] midnight:bg-[#0a0e27] purple:bg-[#1a0b2e] text-gray-600 dark:text-gray-400 midnight:text-cyan-300 purple:text-pink-300 hover:bg-gray-200 dark:hover:bg-[#22262e] midnight:hover:bg-cyan-500/10 purple:hover:bg-pink-500/10"}`}
            >
              All
            </button>
            {TEMPLATE_CATEGORIES.map(cat => (
              <button
                ...
                className={`px-3 py-1.5 rounded-lg text-[12px] font-medium transition-colors cursor-pointer ${activeCategory === cat ? "text-white" : "bg-gray-100 dark:bg-[#1a1d24] midnight:bg-[#0a0e27] purple:bg-[#1a0b2e] text-gray-600 dark:text-gray-400 midnight:text-cyan-300 purple:text-pink-300 hover:bg-gray-200 dark:hover:bg-[#22262e] midnight:hover:bg-cyan-500/10 purple:hover:bg-pink-500/10"}`}
          ...
          <div className="mb-6">
            ...
            >
              ...
              <div className="text-left">
                <p className="text-[14px] font-semibold text-gray-800 dark:text-gray-200 midnight:text-cyan-100 purple:text-pink-100">Blank document</p>
                <p className="text-[12px] text-gray-400">Start from scratch</p>
              </div>
            </button>
          </div>
        )}
        ...
        {!searchQuery && !activeCategory ? (
            ...
            return (
              <div key={cat} className="mb-8">
                <div className="flex items-center gap-2 mb-4">
                  ...
                  <h2 className="text-[14px] font-bold text-gray-800 dark:text-gray-200 midnight:text-cyan-100 purple:text-pink-100">{cat}</h2>
                  <span className="text-[11px] text-gray-400 dark:text-gray-500 midnight:text-cyan-400 purple:text-pink-400 ml-1">{catTemplates.length} templates</span>
                </div>
          ...
          // Filtered results
          <div>
            <p className="text-[12px] text-gray-500 dark:text-gray-400 midnight:text-cyan-300 purple:text-pink-300 mb-4">
  ...
  return (
    <button onClick={onClick} className="group cursor-pointer text-left w-full">
      <div className="aspect-[3/4] rounded-xl bg-white dark:bg-[#0f1115] midnight:bg-[#0a0e27] purple:bg-[#1a0b2e] relative transition-shadow duration-300 hover:shadow-xl"
        ...
        <div className="absolute left-0 right-0 top-0 bottom-0 overflow-hidden rounded-b-xl">
          <div className="w-[420px] origin-top-left pointer-events-none" style={{ transform: "scale(0.355)" }}>
            <div
              className="px-7 pt-5 pb-8 text-[13px] leading-[1.6] text-gray-800 dark:text-gray-200 midnight:text-cyan-100 purple:text-pink-100 [&_h1]:text-[22px] [&_h1]:font-bold [&_h1]:mb-2 [&_h1]:leading-tight [&_h2]:text-[16px] [&_h2]:font-bold [&_h2]:mt-4 [&_h2]:mb-1 [&_h3]:text-[14px] [&_h3]:font-semibold [&_h3]:mt-3 [&_h3]:mb-1 [&_p]:my-1 [&_ul]:pl-5 [&_ul]:my-1 [&_ul]:list-disc [&_li]:my-0.5 [&_hr]:my-3 [&_hr]:border-gray-200 [&_strong]:font-semibold [&_em]:italic"
      ...
      <div className="mt-2 px-0.5">
        <p className="text-[13px] font-semibold text-gray-800 dark:text-gray-200 midnight:text-cyan-100 purple:text-pink-100 truncate">{template.label}</p>
        <p className="text-[11px] text-gray-400 dark:text-gray-500 midnight:text-cyan-400 purple:text-pink-400 mt-0.5">{template.category}</p>
      </div>
    </button>
  );
}
