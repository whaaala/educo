...
export default function SubjectsManagementPage() {
  ...
  return (
    <DashboardPage
      title={isTertiary ? "Course Subjects" : "Class Subjects"}
      breadcrumbs={[
        ...
        <div className="mb-6">
          <div className="relative">
            ...
            <input
              ...
              className="w-full pl-10 pr-4 py-3 border border-gray-300 dark:border-gray-600 midnight:border-cyan-500/30 purple:border-pink-500/30 rounded-lg focus:ring-2 focus:ring-blue-500 dark:bg-[#1a1d24] midnight:bg-[#0a0e27] purple:bg-[#1a0b2e] dark:text-white midnight:text-cyan-50 purple:text-pink-50"
            />
          </div>
        </div>
          ...
          {filteredSubjects.map((subject) => (
            ...
            >
              ...
              <div className="p-6 border-b border-gray-200 dark:border-gray-700 midnight:border-cyan-500/20 purple:border-pink-500/20">
                  ...
                  <div className="relative">
                    ...
                    {showActionsMenu === subject.id && (
                      <div className="absolute right-0 mt-2 w-48 bg-white dark:bg-[#1a1d24] midnight:bg-[#0a0e27] purple:bg-[#1a0b2e] rounded-lg shadow-lg border border-gray-200 dark:border-gray-700 midnight:border-cyan-500/20 purple:border-pink-500/20 z-10">
                        ...
                        <button className="flex items-center gap-2 px-4 py-2 hover:bg-gray-50 dark:hover:bg-[#22262e] midnight:hover:bg-cyan-500/10 purple:hover:bg-pink-500/10 text-red-600 dark:text-red-400 midnight:text-red-400 purple:text-red-400 w-full text-left">
                ...
                <div className="flex items-center gap-4">
                  {subject.credits && (
                    <div className="flex items-center gap-1 text-sm text-gray-600 dark:text-gray-400 midnight:text-cyan-300 purple:text-pink-300">
              ...
              >
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 midnight:border-cyan-500/30 purple:border-pink-500/30 rounded-lg focus:ring-2 focus:ring-blue-500 dark:bg-[#22262e] midnight:bg-[#0f1330] purple:bg-[#251340] dark:text-white midnight:text-cyan-50 purple:text-pink-50"
                    required
                  />
                </div>
                ...
                <div className="flex items-center justify-end gap-3 pt-4">
                  <button
                    ...
                    className="px-4 py-2 border border-gray-300 dark:border-gray-600 midnight:border-cyan-500/30 purple:border-pink-500/30 rounded-lg text-gray-700 dark:text-gray-300 midnight:text-cyan-200 purple:text-pink-200 hover:bg-gray-50 dark:hover:bg-[#22262e] midnight:hover:bg-cyan-500/10 purple:hover:bg-pink-500/10 transition-colors"
                  >
                    Cancel
                  </button>
                  <button
