      ...
      <div className={`transition-opacity duration-500 ${isPageLoading ? "opacity-0" : "opacity-100"}`}>
        ...
        {isSent ? (
          ...
          <div className="bg-white dark:bg-gray-800 rounded-2xl border border-gray-200 dark:border-gray-700 shadow-sm overflow-hidden animate-in fade-in slide-in-from-bottom-2 duration-700 ease-out">
              ...
              <div className="flex flex-col gap-3">
                ...
                <div className="flex flex-wrap gap-2 min-h-[40px]">
                  {recipients.map((parent) => (
                    <div
                      key={parent.id}
                      className="flex items-center gap-2 px-3 py-1.5 bg-blue-50 dark:bg-blue-900/30 border border-blue-200 dark:border-blue-700 rounded-full"
                    >
                      ...
                      <button
                        ...
                        className="p-0.5 rounded-full hover:bg-blue-200 dark:hover:bg-blue-800 text-blue-500 dark:text-blue-400 cursor-pointer"
                      >
                  ...
                  <div className="relative flex-1 min-w-[200px]">
                    <div className="relative">
                      ...
                      <input
                        ...
                        className="w-full pl-10 pr-4 py-2 rounded-xl bg-gray-50 dark:bg-gray-900 border border-gray-200 dark:border-gray-700 focus:border-blue-400 focus:ring-2 focus:ring-blue-500/20 text-sm outline-none"
                      />
                    </div>

                    {/* Recipient Dropdown */}
                    {showRecipientDropdown && (
                      <div className="absolute top-full left-0 right-0 mt-2 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-xl shadow-xl z-50 max-h-[300px] overflow-y-auto">
                        {/* Select All Option */}
                        <button
                          type="button"
                          onClick={handleSelectAll}
                          className="w-full flex items-center gap-3 px-4 py-3 hover:bg-gray-50 dark:hover:bg-gray-700/50 border-b border-gray-100 dark:border-gray-700 cursor-pointer"
                        >
                          <div className="w-8 h-8 rounded-full bg-blue-100 dark:bg-blue-900/30 flex items-center justify-center">
                            <Users className="w-4 h-4 text-blue-600 dark:text-blue-400" />
                          </div>
                          <div className="text-left">
                            <p className="text-sm font-semibold text-gray-900 dark:text-white">Select All Parents</p>
                        ...
                        {filteredParents.slice(0, 10).map((parent) => {
                          ...
                          return (
                            <button
                              ...
                              disabled={!!isSelected}
                              className={`w-full flex items-center gap-3 px-4 py-3 hover:bg-gray-50 dark:hover:bg-gray-700/50 cursor-pointer ${
            ...
            <div className="p-4 lg:p-6 border-b border-gray-100 dark:border-gray-700 grid grid-cols-1 lg:grid-cols-3 gap-4">
              {/* Subject */}
              <div className="lg:col-span-2">
                ...
                <input
                  ...
                  className="w-full px-4 py-3 rounded-xl bg-gray-50 dark:bg-gray-900 border border-gray-200 dark:border-gray-700 focus:border-blue-400 focus:ring-2 focus:ring-blue-500/20 text-sm outline-none"
                />
              </div>
              ...
              <div className="flex gap-3">
                ...
                <div className="flex-1 relative">
                  ...
                  <button
                    ...
                    className="w-full flex items-center justify-between px-4 py-3 rounded-xl bg-gray-50 dark:bg-gray-900 border border-gray-200 dark:border-gray-700 hover:border-gray-300 dark:hover:border-gray-600 text-sm cursor-pointer"
                  >
                  ...
                  {showCategoryDropdown && (
                    <div className="absolute top-full left-0 right-0 mt-2 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-xl shadow-xl z-50">
                      {categories.map((cat) => (
                        <button
                          key={cat}
                          type="button"
                          ...
                          className={`w-full px-4 py-2.5 text-left text-sm hover:bg-gray-50 dark:hover:bg-gray-700/50 cursor-pointer ${
                            category === cat ? "text-blue-600 dark:text-blue-400 font-medium" : "text-gray-700 dark:text-gray-300"
                          }`}
                        >
                          {cat}
                        </button>
            ...
            <div className="p-4 lg:p-6">
              ...
              <textarea
                ...
                rows={8}
                className="w-full px-4 py-3 rounded-xl bg-gray-50 dark:bg-gray-900 border border-gray-200 dark:border-gray-700 focus:border-blue-400 focus:ring-2 focus:ring-blue-500/20 text-sm outline-none resize-y"
              />
            ...
            {/* Footer Actions */}
            <div className="p-4 lg:p-6 border-t border-gray-100 dark:border-gray-700 bg-gray-50/50 dark:bg-gray-800/50">
              <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                ...
                <div className="flex items-center gap-3">
                  <button
                    ...
                    className="px-5 py-2.5 rounded-xl font-medium text-sm text-gray-700 dark:text-gray-300 bg-white dark:bg-gray-700 border border-gray-300 dark:border-gray-600 hover:bg-gray-50 dark:hover:bg-gray-600 transition-colors cursor-pointer"
                  >
                    Cancel
                  </button>
                  <button
