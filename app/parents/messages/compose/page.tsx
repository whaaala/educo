...
const categoryColors: Record<string, string> = {
  blue: "bg-blue-100 dark:bg-blue-900/30 text-blue-600 dark:text-blue-400 border-blue-200 dark:border-blue-800 ring-blue-500/20",
  ...
  amber: "bg-amber-100 dark:bg-amber-900/30 text-amber-600 dark:text-amber-400 border-amber-200 dark:border-amber-800 ring-amber-500/20",
  ...
  gray: "bg-gray-100 dark:bg-gray-700/30 text-gray-600 dark:text-gray-400 border-gray-200 dark:border-gray-700 ring-gray-500/20",
};
              ...
              <>
                ...
                <div className="p-6 space-y-6">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                          ...
                          {selectedTeacher ? (
                            <>
                              ...
                              <div className="flex-1 text-left min-w-0">
                                <p className="font-medium text-gray-900 dark:text-white text-sm truncate">{selectedTeacher.name}</p>
                                <p className="text-xs text-gray-500 dark:text-gray-400 truncate">{selectedTeacher.subject}</p>
                              </div>
                            </>
                          ) : (
                            <>
                              ...
                              <span className="flex-1 text-left text-gray-400 dark:text-gray-500 text-sm">Choose a teacher...</span>
                            </>
                          )}
                            ...
                            <div className="p-3 border-b border-gray-100 dark:border-gray-700">
                              <div className="relative">
                                ...
                                <input
                                  ...
                                  className="w-full pl-10 pr-4 py-2 rounded-lg bg-gray-50 dark:bg-gray-700 text-gray-900 dark:text-white text-sm border-0 focus:ring-2 focus:ring-blue-500/30 outline-none"
                                  autoFocus
                                />
                              </div>
                            </div>
                              ...
                              {filteredTeachers.map((teacher) => (
                                ...
                                >
                                  ...
                                  <div className="flex-1 text-left min-w-0">
                                    ...
                                    <p className="text-xs text-gray-500 dark:text-gray-400 truncate">{teacher.subject}</p>
                                  </div>
                                  {selectedTeacherId === teacher.id && (
                    ...
                    <div className="space-y-2">
                      ...
                      <div className="relative">
                        ...
                        >
                          {selectedChild ? (
                            <>
                              ...
                              <div className="flex-1 text-left min-w-0">
                                <p className="font-medium text-gray-900 dark:text-white text-sm truncate">{selectedChild.name}</p>
                                <p className="text-xs text-gray-500 dark:text-gray-400">{selectedChild.class}</p>
                              </div>
                            </>
                          ) : (
                            <>
                              ...
                              <span className="flex-1 text-left text-gray-400 dark:text-gray-500 text-sm">Select child (optional)</span>
                            </>
                          )}
                        ...
                        {/* Child Dropdown */}
                        {showChildDropdown && (
                          <div className="absolute top-full left-0 right-0 mt-2 bg-white dark:bg-gray-800 rounded-xl shadow-xl border border-gray-200 dark:border-gray-700 z-50 overflow-hidden p-2">
                            {MOCK_CHILDREN.map((child) => (
                              ...
                              >
                                ...
                                <div className="flex-1 text-left">
                                  <p className="font-medium text-gray-900 dark:text-white text-sm">{child.name}</p>
                                  <p className="text-xs text-gray-500 dark:text-gray-400">{child.class}</p>
                                </div>
                                {selectedChildId === child.id && (
                            ...
                            {selectedChildId && (
                              <button
                                ...
                                className="w-full mt-1 p-2 text-sm text-gray-500 hover:text-gray-700 dark:hover:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-700/50 rounded-lg transition-colors cursor-pointer"
                              >
                                Clear selection
                              </button>
                            )}
                  ...
                  <div className="space-y-2">
                    ...
                    <input
                      ...
                      className="w-full px-4 py-3 rounded-xl bg-gray-50 dark:bg-gray-700/50 border-2 border-gray-200 dark:border-gray-700 text-gray-900 dark:text-white placeholder:text-gray-400 focus:border-blue-500 dark:focus:border-blue-400 focus:ring-4 focus:ring-blue-500/10 outline-none transition-all"
                    />
                  </div>
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="relative">
                      <textarea
                        ...
                        rows={8}
                        className="w-full px-4 py-3 pb-14 rounded-xl bg-gray-50 dark:bg-gray-700/50 border-2 border-gray-200 dark:border-gray-700 text-gray-900 dark:text-white placeholder:text-gray-400 focus:border-blue-500 dark:focus:border-blue-400 focus:ring-4 focus:ring-blue-500/10 outline-none transition-all resize-none"
                      />
                      <div className="absolute bottom-3 left-3 right-3 flex items-center justify-between">
                        <div className="flex items-center gap-1">
                          ...
                          <button
                            ...
                            className="p-2 rounded-lg text-gray-400 hover:text-gray-600 hover:bg-gray-200 dark:hover:bg-gray-600 transition-colors cursor-pointer"
                          >
                      ...
                      <div className="flex flex-wrap gap-2 mt-3">
                        {attachments.map((attachment) => {
                          ...
                          return (
                            <div
                              key={attachment.id}
                              className="relative group flex items-center gap-2 px-3 py-2 bg-gray-100 dark:bg-gray-700/50 rounded-xl border border-gray-200 dark:border-gray-600"
                            >
                              {attachment.preview ? (
                ...
                <div className="px-6 py-4 border-t border-gray-200 dark:border-gray-700 bg-gray-50/50 dark:bg-gray-800/50">
                  <div className="flex items-center justify-between gap-4">
                    <Link href="/parents/messages">
                      <button className="px-5 py-2.5 rounded-xl text-sm font-medium text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white hover:bg-gray-100 dark:hover:bg-gray-700 transition-all cursor-pointer">
                        Cancel
                      </button>
                    </Link>
                    <ActionButton
