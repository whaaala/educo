        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-6 sm:p-8 space-y-6">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div className="p-4 rounded-xl bg-primary-50 dark:bg-primary-900/20 border border-primary-100 dark:border-primary-800/30">
                  <div className="flex items-start gap-3">
                    <div className="w-10 h-10 rounded-lg bg-white dark:bg-gray-800 shadow-sm" />
              ...
              <div className="p-5 rounded-2xl bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-700/40 dark:to-gray-700/20 border border-gray-200 dark:border-gray-600 space-y-2">
                <div className="h-3 w-24 bg-gray-200 dark:bg-gray-600 rounded" />
                <div className="h-5 w-full bg-gray-200 dark:bg-gray-600 rounded" />
              </div>
            ...
            <div className="bg-white dark:bg-gray-800 rounded-2xl border border-gray-100 dark:border-gray-700 overflow-hidden">
              <div className="px-5 sm:px-6 py-4 border-b border-gray-100 dark:border-gray-700/50 flex items-center gap-3">
          ...
          <div className="space-y-6">
            ...
            <div className="bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-800 dark:to-gray-850 rounded-2xl border border-gray-100 dark:border-gray-700 p-5 space-y-3">
