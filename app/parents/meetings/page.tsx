          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            {hasVideoCapability && (
              ...
              >
                ...
                <div className="text-left">
                  <p className="font-semibold text-ink text-sm">Video Call</p>
                  <p className="text-xs text-muted">Start video meeting</p>
                </div>
            ...
            {hasVoiceCapability && (
              <button
                ...
                className="group flex items-center gap-4 p-4 bg-surface rounded-2xl border border-gray-100 dark:border-gray-700 midnight:border-cyan-500/20 purple:border-pink-500/20 shadow-sm hover:shadow-lg hover:border-emerald-300 dark:hover:border-emerald-600/50 transition-all duration-200 cursor-pointer"
              >
                ...
                <div className="text-left">
                  <p className="font-semibold text-ink text-sm">Voice Call</p>
                  <p className="text-xs text-muted">Start audio call</p>
                </div>
            ...
            {hasChatCapability && (
              <button
                ...
                className="group flex items-center gap-4 p-4 bg-surface rounded-2xl border border-gray-100 dark:border-gray-700 midnight:border-cyan-500/20 purple:border-pink-500/20 shadow-sm hover:shadow-lg hover:border-purple-300 dark:hover:border-purple-600/50 transition-all duration-200 cursor-pointer"
              >
                ...
                <div className="text-left">
                  <p className="font-semibold text-ink text-sm">Chat</p>
                  <p className="text-xs text-muted">Send instant message</p>
                </div>
            ...
            {hasWhatsApp && (
              <button className="group flex items-center gap-4 p-4 bg-surface rounded-2xl border border-gray-100 dark:border-gray-700 midnight:border-cyan-500/20 purple:border-pink-500/20 shadow-sm hover:shadow-lg hover:border-emerald-300 dark:hover:border-emerald-600/50 transition-all duration-200 cursor-pointer">
                <div className="p-3 rounded-xl bg-emerald-50 dark:bg-emerald-900/30 text-emerald-600 dark:text-emerald-400 group-hover:scale-110 transition-transform">
                  <WhatsAppIcon />
                </div>
                <div className="text-left">
                  <p className="font-semibold text-ink text-sm">WhatsApp</p>
                  <p className="text-xs text-muted">External messaging</p>
                </div>
                <ChevronRight className="w-5 h-5 text-gray-400 ml-auto group-hover:text-emerald-500 group-hover:translate-x-1 transition-all" />
              </button>
            )}
                        ...
                        <div className="flex items-center gap-4 flex-1">
                          ...
                          <div className="flex-1 min-w-0">
                            <div className="flex items-center gap-2 mb-1">
                              ...
                              <span className={`flex items-center gap-1 px-2 py-0.5 rounded-md text-[0.625rem] font-bold ${statusInfo.bgClass} ${statusInfo.textClass}`}>
                                {statusInfo.icon}
                                {statusInfo.label}
                              </span>
                            </div>
                            ...
                            <div className="flex flex-wrap items-center gap-3 mt-2 text-xs text-muted">
                              ...
                              {meeting.childName && (
                                <span className="px-2 py-0.5 rounded-md bg-surface-2 font-medium">
                                  {meeting.childName}
                                </span>
                              )}
                            </div>
                    ...
                    <div className="flex items-center gap-4">
                      ...
                      <div className="flex-1 min-w-0">
                        <div className="flex items-center gap-2">
                          ...
                          <span className={`flex items-center gap-1 px-1.5 py-0.5 rounded text-[0.5625rem] font-bold ${statusInfo.bgClass} ${statusInfo.textClass}`}>
                            {statusInfo.icon}
                            {statusInfo.label}
                          </span>
                        </div>
