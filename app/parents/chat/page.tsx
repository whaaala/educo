  ...
  return (
    <DashboardPage
      ...
      afterStats={
        ...
        {/* Chat Container */}
        <div className="bg-surface rounded-2xl border border-line shadow-sm overflow-hidden h-[calc(100vh-220px)] min-h-[500px] flex">
          {/* Sidebar - Conversations List */}
          <div className={`w-full lg:w-80 xl:w-96 border-r border-line flex flex-col ${showMobileChat ? "hidden lg:flex" : "flex"}`}>
            {/* Search */}
            <div className="p-4 border-b border-gray-100 dark:border-gray-700 midnight:border-cyan-500/20 purple:border-pink-500/20">
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-10 pr-4 py-2.5 rounded-xl bg-canvas border border-line focus:border-blue-400 focus:ring-2 focus:ring-blue-500/20 text-sm outline-none"
                />
              </div>
            </div>
            ...
            <div className="flex-1 overflow-y-auto">
              {filteredConversations.length === 0 ? (
                <div className="flex flex-col items-center justify-center py-12 px-4">
                  ...
                  <p className="text-sm text-muted text-center">No conversations yet</p>
                </div>
              ) : (
                  ...
                  >
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex items-center justify-between gap-2 mb-0.5">
                        <p className={`text-sm truncate ${conv.unreadCount > 0 ? "font-semibold text-ink" : "font-medium text-gray-700 dark:text-gray-300 midnight:text-cyan-200 purple:text-pink-200"}`}>
                          {conv.contact.name}
                        </p>
                        <span className="text-xs text-muted flex-shrink-0">{formatTime(conv.lastMessage.timestamp)}</span>
                      </div>
                      <div className="flex items-center justify-between gap-2">
                        <div className="flex items-center gap-1.5 min-w-0">
                          ...
                          <p className={`text-xs truncate ${conv.unreadCount > 0 ? "font-medium text-gray-800 dark:text-gray-200 midnight:text-cyan-100 purple:text-pink-100" : "text-muted"}`}>
            ...
            {selectedContact ? (
              <>
                ...
                <div className="flex items-center gap-3 p-4 border-b border-line bg-surface">
                  ...
                  <div className="flex-1 min-w-0">
                    <p className="text-sm font-semibold text-ink truncate">{selectedContact.name}</p>
                    <p className={`text-xs ${selectedContact.isOnline ? "text-green-600 dark:text-green-400 midnight:text-emerald-400 purple:text-emerald-400" : "text-muted"}`}>
                              ...
                              <div
                                className={`px-4 py-2.5 rounded-2xl ${
                                  isParent
                                    ...
                                    : "bg-surface text-gray-800 dark:text-gray-200 midnight:text-cyan-100 purple:text-pink-100 rounded-bl-md border border-line"
                                }`}
                              >
                  ...
                  {isTyping && (
                    <div className="flex justify-start">
                      <div className="flex items-end gap-2">
                        ...
                        <div className="px-4 py-3 rounded-2xl bg-surface border border-line rounded-bl-md">
