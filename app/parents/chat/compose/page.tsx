          ...
          {!selectedStaff ? (
            ...
            <div className="flex-1 flex flex-col">
              <div className="p-6 border-b border-gray-100 dark:border-gray-700">
                ...
                <p className="text-sm text-gray-500 dark:text-gray-400">Select a teacher or staff member to start chatting</p>
              </div>
                      ...
                      >
                        ...
                        <div className="flex-1 min-w-0">
                          ...
                          <div className="flex items-center gap-2">
                            ...
                            {staff.subject && (
                              <span className="text-xs text-gray-500 dark:text-gray-400">{staff.subject}</span>
                            )}
                          </div>
                          <p className="text-xs text-gray-400 dark:text-gray-500 truncate mt-0.5">{staff.email}</p>
                        </div>
            ...
            <div className="flex-1 flex flex-col">
              ...
              <div className="flex items-center gap-4 p-4 border-b border-gray-100 dark:border-gray-700 bg-gray-50/50 dark:bg-gray-800/50">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <p className={`text-xs ${selectedStaff.isOnline ? "text-green-600 dark:text-green-400" : "text-gray-500 dark:text-gray-400"}`}>
