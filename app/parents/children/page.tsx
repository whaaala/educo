                  ...
                  <div className="flex flex-col h-full p-4 rounded-xl bg-gradient-to-br from-slate-50 via-white to-indigo-50/30 dark:from-gray-800/60 dark:via-gray-800/40 dark:to-indigo-900/20 midnight:from-gray-800/40 midnight:via-gray-900/30 midnight:to-cyan-900/10 purple:from-gray-800/40 purple:via-gray-900/30 purple:to-pink-900/10 border border-gray-200/60 dark:border-gray-700/50 shadow-sm">
                    ...
                    <div className="flex-1 grid grid-cols-2 lg:grid-cols-3 gap-2">
                      ...
                      >
                        ...
                        <div className="relative flex-1 min-w-0">
                          <p className="text-xs font-semibold text-gray-900 dark:text-white leading-tight">Term Progress</p>
                      ...
                      >
                        ...
                        <div className="relative flex-1 min-w-0">
                          <p className="text-xs font-semibold text-gray-900 dark:text-white leading-tight">Report Card</p>
                          <p className="text-[10px] text-blue-600/70 dark:text-blue-400/70 leading-tight">View grades</p>
                        </div>
                      </Link>
                      <Link
                      ...
                      >
                        ...
                        <div className="relative flex-1 min-w-0">
                          <p className="text-xs font-semibold text-gray-900 dark:text-white leading-tight">Pay Fees</p>
                          <p className="text-[10px] text-green-600/70 dark:text-green-400/70 leading-tight">Make payment</p>
                        </div>
                      </Link>
                      <Link
                      ...
                      >
                        ...
                        <div className="relative flex-1 min-w-0">
                          <p className="text-xs font-semibold text-gray-900 dark:text-white leading-tight">Message</p>
                      ...
                      >
                        ...
                        <div className="relative flex-1 min-w-0">
                          <p className="text-xs font-semibold text-gray-900 dark:text-white leading-tight">Timetable</p>
                          <p className="text-[10px] text-red-600/70 dark:text-red-400/70 leading-tight">View schedule</p>
                        </div>
                      </Link>
                    </div>
                  </div>
