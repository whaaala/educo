...
function MobileStatCard({ icon: Icon, label, value, subtitle, color }: MobileStatCardProps) {
  ...
  return (
    <div className={`${config.bg} rounded-2xl border border-gray-100/80 dark:border-gray-700 midnight:border-cyan-500/20 purple:border-pink-500/20 p-4 min-w-[140px] snap-start flex-shrink-0 shadow-sm hover:shadow-md transition-all duration-200`}>
      ...
      {/* Subtitle */}
      {subtitle && (
        <p className="text-[0.625rem] text-gray-400 dark:text-gray-500 midnight:text-cyan-400 purple:text-pink-400 mt-0.5">{subtitle}</p>
      )}
    </div>
  );
}
    ...
    <div className={`group relative ${config.bg} rounded-2xl border border-gray-100/80 dark:border-gray-700 midnight:border-cyan-500/20 purple:border-pink-500/20 p-4 shadow-sm hover:shadow-lg hover:-translate-y-0.5 transition-all duration-300 overflow-hidden`}>
      ...
      <div className="relative flex items-center gap-3">
        ...
        <div className="flex-1 min-w-0">
          <p className="text-[0.625rem] font-semibold text-muted uppercase tracking-wider mb-0.5">{label}</p>
          <p className={`text-xl font-bold ${config.valueColor}`}>{value}</p>
          {subtitle && (
            <p className="text-[0.625rem] text-gray-400 dark:text-gray-500 midnight:text-cyan-400 purple:text-pink-400">{subtitle}</p>
          )}
        </div>
      </div>
    </div>
    ...
    <DashboardPage
      ...
      afterStats={
        ...
        <div className="md:hidden space-y-4">
          ...
          <div className="relative">
            ...
            <div className="relative bg-white dark:bg-[#1a1d24] midnight:bg-[#0a0e27]/90 purple:bg-[#1a0b2e]/90 rounded-2xl border border-gray-100/80 dark:border-gray-700 midnight:border-cyan-500/20 purple:border-pink-500/20 p-4 shadow-sm">
              ...
              <div className="flex items-center justify-between mb-3">
                ...
                <div className="flex items-center gap-2">
                  <button className="p-2 rounded-xl bg-gray-50 dark:bg-[#22262e] midnight:bg-[#0f1330] purple:bg-[#251340]/50 hover:bg-gray-100 dark:hover:bg-[#22262e] midnight:hover:bg-cyan-500/10 purple:hover:bg-pink-500/10 transition-colors">
                  ...
                  <button
                    type="button"
                    onClick={reset}
                    className="inline-flex items-center gap-1.5 px-2.5 py-2 rounded-xl bg-gray-50 dark:bg-[#22262e] midnight:bg-[#0f1330] purple:bg-[#251340]/50 hover:bg-gray-100 dark:hover:bg-[#22262e] midnight:hover:bg-cyan-500/10 purple:hover:bg-pink-500/10 transition-colors"
                    title={customized ? "Reset widgets to default" : "Widgets are already on the default layout"}
                    aria-label="Reset widgets"
                  >
                    <RotateCcw className="w-4 h-4 text-muted" />
                    <span className="text-xs font-medium text-gray-600 dark:text-gray-300 midnight:text-cyan-200 purple:text-pink-200">Reset</span>
                  </button>
                </div>
              </div>
              ...
              <div className="flex flex-wrap items-center gap-2 mb-4">
                <div className="inline-flex items-center gap-1.5 px-2.5 py-1.5 rounded-lg bg-blue-50/80 dark:bg-blue-500/10 border border-blue-100/50 dark:border-blue-500 midnight:border-cyan-500 purple:border-pink-500/20">
                  <GraduationCap className="w-3.5 h-3.5 text-blue-600 dark:text-blue-400 midnight:text-cyan-400 purple:text-pink-400" />
                  <span className="text-[0.6875rem] font-medium text-blue-700 dark:text-blue-400 midnight:text-cyan-400 purple:text-pink-400">Parent Portal</span>
                </div>
                <div className="inline-flex items-center gap-1.5 px-2.5 py-1.5 rounded-lg bg-gray-50/80 dark:bg-[#22262e] midnight:bg-[#0f1330] purple:bg-[#251340]/50 border border-gray-100/50 dark:border-gray-700 midnight:border-cyan-500/20 purple:border-pink-500/20">
                  ...
                  <span className="text-[0.6875rem] font-medium text-gray-600 dark:text-gray-400 midnight:text-cyan-300 purple:text-pink-300">2nd Term 2024</span>
                </div>
              </div>
              ...
              <div className="bg-gray-50/80 dark:bg-[#0f1115] midnight:bg-[#0a0e27] purple:bg-[#1a0b2e]/40 midnight:bg-[#0f1330]/40 purple:bg-[#251340]/40 rounded-xl p-3 border border-gray-100/80 dark:border-gray-700 midnight:border-cyan-500/20 purple:border-pink-500/20">
                <div className="flex items-center justify-between mb-2.5">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-xs font-semibold text-gray-700 dark:text-gray-300 midnight:text-cyan-200 purple:text-pink-200">My Children</span>
                  </div>
                  <Link href="/parents/children" className="text-[0.625rem] font-semibold text-blue-600 dark:text-blue-400 midnight:text-cyan-400 purple:text-pink-400 hover:underline">
                    Open
                  </Link>
                </div>
                    ...
                    return (
                      <button
                        ...
                        className={`flex items-center gap-2 px-3 py-2 rounded-xl transition-all duration-200 flex-shrink-0 ${
                          isSelected
                            ? "bg-surface shadow-sm border-2 border-blue-500/50 dark:border-blue-400/50"
                      ...
                      >
                        ...
                        <div className="text-left">
                          <p className={`text-xs font-semibold ${isSelected ? "text-blue-700 dark:text-blue-400 midnight:text-cyan-400 purple:text-pink-400" : "text-gray-700 dark:text-gray-300 midnight:text-cyan-200 purple:text-pink-200"}`}>
                            {child.firstName}
                          </p>
                          <p className="text-[0.625rem] text-muted">{child.classLevel}</p>
                        </div>
                      </button>
                    );
                  })}
              ...
              <div className="flex items-center justify-between mt-3 pt-3 border-t border-gray-100/80 dark:border-gray-700 midnight:border-cyan-500/20 purple:border-pink-500/20">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="text-[0.625rem] text-muted">Viewing</p>
                    <p className="text-sm font-semibold text-gray-800 dark:text-gray-100 midnight:text-cyan-50 purple:text-pink-50">{selectedChild.firstName} {selectedChild.lastName} • {selectedChild.classLevel}</p>
                  </div>
                </div>
            ...
            <div className="mt-3 relative">
              ...
              <input
                ...
                className="w-full pl-10 pr-4 py-3 rounded-xl bg-surface/90 border border-gray-100/80 dark:border-gray-700 midnight:border-cyan-500/20 purple:border-pink-500/20 text-sm text-ink placeholder:text-gray-400 dark:placeholder:text-gray-500 focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-400 transition-all"
              />
            </div>
          </div>
          ...
          <div className="space-y-2">
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-2">
                <span className="text-xs font-semibold text-gray-800 dark:text-gray-100 midnight:text-cyan-50 purple:text-pink-50">{selectedChild.firstName}&apos;s Stats</span>
                <span className="inline-flex items-center gap-1 px-2 py-0.5 rounded-full text-[0.625rem] font-medium bg-indigo-50 text-indigo-600 dark:bg-indigo-500/10 dark:text-indigo-400">
              ...
              <Link
                ...
                className="inline-flex items-center gap-0.5 text-xs font-medium text-blue-600 hover:text-blue-700 dark:text-blue-400 midnight:text-cyan-400 purple:text-pink-400 dark:hover:text-blue-300 transition-colors"
              >
                View Details
        ...
        <div className="hidden md:block lg:hidden space-y-5">
          ...
          <div className="relative bg-white dark:bg-[#1a1d24] midnight:bg-[#0a0e27]/90 purple:bg-[#1a0b2e]/90 rounded-2xl border border-gray-100/80 dark:border-gray-700 midnight:border-cyan-500/20 purple:border-pink-500/20 p-5 shadow-sm overflow-hidden">
            ...
            <div className="relative flex items-start justify-between gap-6">
              ...
              <div className="flex-1">
                <p className="text-xs font-medium text-muted mb-1">{currentDate}</p>
                ...
                <div className="flex flex-wrap items-center gap-2">
                  <div className="inline-flex items-center gap-1.5 px-3 py-2 rounded-xl bg-blue-50/80 dark:bg-blue-500/10 border border-blue-100/50 dark:border-blue-500 midnight:border-cyan-500 purple:border-pink-500/20">
          ...
          <div className="space-y-3">
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-3">
                <h3 className="text-sm font-semibold text-gray-800 dark:text-gray-100 midnight:text-cyan-50 purple:text-pink-50">{selectedChild.firstName}&apos;s Current Term</h3>
              ...
              <Link
                href={`/parents/children/${selectedChild.id}/term-progress`}
                className="inline-flex items-center gap-1 text-sm font-medium text-blue-600 hover:text-blue-700 dark:text-blue-400 midnight:text-cyan-400 purple:text-pink-400 dark:hover:text-blue-300 transition-colors"
              >
                View Details
        ...
        <div className="hidden lg:block space-y-5">
          ...
          <div className="flex flex-wrap items-center justify-end gap-2">
              {/* Current Term Info */}
              <div className="flex items-center gap-2 px-3 py-2 rounded-lg border border-line bg-surface">
                <Calendar className="w-4 h-4 text-blue-600 dark:text-blue-400 midnight:text-cyan-400 purple:text-pink-400" />
                <div>
                  <p className="text-[0.625rem] text-blue-600 dark:text-blue-400 midnight:text-cyan-400 purple:text-pink-400 font-medium">Current Term</p>
                  <p className="text-xs font-bold text-ink">2nd Term 2024</p>
                </div>
              </div>
              ...
              <div className="flex items-center gap-2 px-3 py-2 rounded-lg border border-line bg-surface">
                ...
                <div>
                  <p className="text-[0.625rem] text-gray-500 dark:text-gray-400 midnight:text-gray-400 purple:text-gray-400 font-medium">Viewing</p>
                  <p className="text-xs font-bold text-ink">{selectedChild.firstName} • {selectedChild.classLevel}</p>
                </div>
              </div>
              ...
              <button
                type="button"
                onClick={reset}
                className="flex items-center gap-2 px-3 py-2.5 border border-line bg-surface hover:bg-gray-50 dark:hover:bg-[#22262e] midnight:hover:bg-cyan-500/5 purple:hover:bg-pink-500/5 text-gray-700 dark:text-gray-200 midnight:text-gray-200 purple:text-gray-200 rounded-lg font-medium text-sm transition-all"
                title={customized ? "Reset widgets to default" : "Widgets are already on the default layout"}
              >
                <RotateCcw className="w-4 h-4" />
                Reset widgets
      ...
      {selectedFee && (
        <SuccessModal
          ...
          fields={[
            { icon: <CreditCard className="w-4 h-4 text-blue-600 dark:text-blue-400 midnight:text-cyan-400 purple:text-pink-400" />, label: "Fee Type", value: selectedFee.feeType },
            { icon: <Users className="w-4 h-4 text-blue-600 dark:text-blue-400 midnight:text-cyan-400 purple:text-pink-400" />, label: "Child", value: selectedFee.childName },
            ...
            { icon: <Calendar className="w-4 h-4 text-blue-600 dark:text-blue-400 midnight:text-cyan-400 purple:text-pink-400" />, label: "Date", value: paymentDate },
          ]}
