...
export default function StaffDocumentsCard() {
  // Mock documents data
  const documents = [
    { name: "Resume/CV", uploadDate: "Jan 15, 2024", size: "2.4 MB", url: "" },
    { name: "Degree Certificate", uploadDate: "Jan 15, 2024", size: "1.8 MB", url: "" },
    { name: "ID Document", uploadDate: "Jan 15, 2024", size: "0.9 MB", url: "" },
  ];
