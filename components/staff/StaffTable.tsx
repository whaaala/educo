    ...
    },
    {
      ...
      render: (staffMember) => (
        <div className="flex items-center justify-start">
          <span
            className={`inline-flex items-center justify-center px-2 md:px-3 xl:px-3.5 py-1 md:py-1.5 xl:py-2 rounded-full text-[0.625rem] md:text-xs xl:text-sm font-semibold shadow-sm transition-all duration-300 whitespace-nowrap ${getStatusBadgeColor(staffMember.employmentStatus)}`}
          >
            ...
            <button
              ...
              onClick={(e) => {
                ...
                startVoiceCall({
                  ...
                  role: "Staff",
                }, { callContext: `Voice call with ${staffMember.firstName}` });
              }}
            >
            ...
            <button
              ...
              onClick={(e) => {
                ...
                startVideoCall({
                  ...
                  email: staffMember.email,
                  role: "Staff",
                }, { callContext: `Video call with ${staffMember.firstName}` });
              }}
            >
