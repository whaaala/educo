    ...
    <header className="bg-white dark:bg-[#1a1d23] midnight:bg-[#0f1729] purple:bg-[#2a1a3e] midnight:bg-[#0f1729] purple:bg-[#2a1a3e] border-b border-gray-200 dark:border-gray-800/50 midnight:border-cyan-500/20 purple:border-pink-500/20 sticky top-0 z-30 transition-colors duration-300 backdrop-blur-xl dark:backdrop-blur-xl dark:bg-opacity-90">
      <div className="flex items-center justify-between px-6 py-3">
        ...
        <div className="flex-1 max-w-md">
          <div className="relative">
            <input
              type="text"
              placeholder="Search"
              className="w-full pl-10 pr-4 py-2 border border-gray-300 dark:border-gray-700 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 dark:focus:ring-blue-400 focus:border-transparent text-sm bg-gray-50 dark:bg-[#0f1115] midnight:bg-[#0a0e27] purple:bg-[#1a0b2e] dark:text-gray-100 midnight:text-cyan-50 purple:text-pink-50 dark:placeholder-gray-500 transition-colors duration-300"
            />
        ...
        <div className="flex items-center gap-1">
            ...
            <button
              ...
              className={`flex items-center gap-2 px-3 py-2 text-sm font-medium transition-all duration-200 rounded-lg border ${
                isYearDropdownOpen
                  ...
                  : "bg-white dark:bg-[#1a1d23] midnight:bg-[#0f1729] purple:bg-[#2a1a3e] midnight:bg-[#0f1729] purple:bg-[#2a1a3e] border-gray-200 dark:border-gray-700 text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-[#252930] hover:border-gray-300 dark:hover:border-gray-600"
              }`}
            >
          ...
          <button
            onClick={cycleTheme}
            className="p-2 hover:bg-gray-100 dark:hover:bg-[#252930] midnight:hover:bg-blue-900/20 purple:hover:bg-purple-900/20 rounded-md transition-colors relative group"
