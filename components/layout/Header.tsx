            ...
            <span className={`inline-flex items-center px-2.5 py-1 rounded-full text-xs font-semibold border ${
              isParent
                ...
                : isAnyAdmin
                  ...
                  : "bg-gray-50 text-gray-700 border-gray-200 dark:bg-[#1a1d24] midnight:bg-[#111827]/50 purple:bg-[#2a1447]/50 dark:text-gray-300 midnight:text-cyan-200 purple:text-pink-200 dark:border-gray-700 midnight:border-cyan-500/20 purple:border-pink-500/20"
            }`}>
          ...
          <div className="relative" ref={yearDropdownRef}>
            <button
              ...
              className={`flex items-center gap-2 px-3 py-2 h-10 text-sm font-medium transition-all duration-200 rounded-lg border cursor-pointer ${
                isYearDropdownOpen
                  ? "bg-blue-50 dark:bg-blue-500/15 midnight:bg-cyan-500/10 purple:bg-pink-500/10 border-blue-300 dark:border-blue-500 midnight:border-cyan-500/30 purple:border-pink-500/30 text-blue-700 dark:text-blue-300 midnight:text-cyan-300 purple:text-pink-300 shadow-sm"
