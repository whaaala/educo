    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-2">
          <button
            onClick={handleReset}
            className="flex items-center gap-2 px-4 py-2 text-sm font-medium text-gray-700 dark:text-gray-300 bg-gray-100 dark:bg-[#22262e] hover:bg-gray-200 dark:hover:bg-[#2a2d35] rounded-lg transition-colors"
          >
      ...
      <div className="p-4 bg-gradient-to-r from-blue-50 to-purple-50 dark:from-blue-900/20 dark:to-purple-900/20 rounded-lg border border-blue-200 dark:border-blue-800">
        ...
        <div className="mt-2 h-2 bg-gray-200 dark:bg-[#22262e] rounded-full overflow-hidden">
          <div
        ...
        {components.map((component) => (
          <div
            ...
            className={`p-4 rounded-lg border transition-all ${
              component.enabled
                ? "bg-white dark:bg-[#1a1d24] border-gray-200 dark:border-gray-700"
                : "bg-gray-50 dark:bg-[#1a1d24]/50 border-gray-300 dark:border-gray-700 opacity-60"
            }`}
          >
            <div className="flex items-start gap-4">
              ...
              <div className="flex items-center pt-1">
                <input
                  ...
                  className="w-5 h-5 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-[#22262e] dark:border-gray-600"
                />
              </div>
              ...
              <div className="flex-1 space-y-2">
                <div className="flex items-center gap-2 flex-wrap">
                  ...
                  <button
                    ...
                    className="inline-flex items-center gap-1 px-2 py-0.5 rounded-md text-xs font-medium text-gray-600 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-[#22262e] transition-colors"
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-3 py-1.5 text-sm border border-gray-300 dark:border-gray-600 rounded-md bg-white dark:bg-[#22262e] text-gray-900 dark:text-gray-100 disabled:opacity-50 disabled:cursor-not-allowed focus:ring-2 focus:ring-blue-500 dark:focus:ring-blue-600"
                  />
                </div>
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <input
                      ...
                      disabled={!component.enabled}
                      className="w-20 px-2 py-1 text-sm border border-gray-300 dark:border-gray-600 rounded-md bg-white dark:bg-[#22262e] text-gray-900 dark:text-gray-100 disabled:opacity-50 disabled:cursor-not-allowed"
                    />
      ...
      <div className="pt-4 border-t border-gray-200 dark:border-gray-700">
        {!showAddCustom ? (
          ...
          <div className="p-4 bg-gray-50 dark:bg-[#1a1d24]/50 rounded-lg space-y-3 relative z-10">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
              <div>
                ...
                <input
                  ...
                  className="w-full px-3 py-2 text-sm border border-gray-300 dark:border-gray-600 rounded-md bg-white dark:bg-[#22262e] text-gray-900 dark:text-gray-100"
                />
              </div>
