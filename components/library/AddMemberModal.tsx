          ...
          <div className="space-y-4">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              <button
                ...
                className="group relative p-5 rounded-xl border-2 transition-all duration-200 hover:shadow-lg text-left border-gray-200 dark:border-gray-700 midnight:border-cyan-500/20 purple:border-pink-500/20 hover:border-purple-400 dark:hover:border-purple-600 bg-white dark:bg-[#1a1d24] midnight:bg-[#0a0e27] purple:bg-[#1a0b2e]"
              >
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1 min-w-0">
                    <h3 className="font-semibold text-gray-900 dark:text-white midnight:text-cyan-50 purple:text-pink-50 mb-1">Student</h3>
              ...
              <button
                ...
                className="group relative p-5 rounded-xl border-2 transition-all duration-200 hover:shadow-lg text-left border-gray-200 dark:border-gray-700 midnight:border-cyan-500/20 purple:border-pink-500/20 hover:border-blue-400 dark:hover:border-blue-600 bg-white dark:bg-[#1a1d24] midnight:bg-[#0a0e27] purple:bg-[#1a0b2e]"
              >
                <div className="flex items-start gap-4">
                  <div className="p-3 rounded-xl bg-blue-100 dark:bg-blue-900/30 midnight:bg-cyan-900/30 purple:bg-pink-900/30 text-blue-600 dark:text-blue-400 midnight:text-cyan-400 purple:text-pink-400">
                    <Users className="w-6 h-6" />
                  </div>
                  <div className="flex-1 min-w-0">
                    <h3 className="font-semibold text-gray-900 dark:text-white midnight:text-cyan-50 purple:text-pink-50 mb-1">Personnel</h3>
                    <p className="text-xs text-gray-500 dark:text-gray-400 midnight:text-cyan-300 purple:text-pink-300">
        ...
        {currentStep === "personnel-type" && (
          <div className="space-y-4">
            ...
            <div className="flex items-center justify-center">
              <span className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-xs font-semibold border bg-blue-100 text-blue-700 dark:bg-blue-900/30 midnight:bg-cyan-900/30 purple:bg-pink-900/30 dark:text-blue-400 midnight:text-cyan-400 purple:text-pink-400 border-blue-200 dark:border-blue-800">
              ...
              {personnelTypeOptions.map((option) => {
                ...
                return (
                  <button
                    ...
                    className={`group relative p-5 rounded-xl border-2 transition-all duration-200 hover:shadow-lg text-left border-gray-200 dark:border-gray-700 midnight:border-cyan-500/20 purple:border-pink-500/20 bg-white dark:bg-[#1a1d24] midnight:bg-[#0a0e27] purple:bg-[#1a0b2e] ${
                      isCyan
                  ...
                  >
                    <div className="flex items-start gap-4">
                      ...
                      <div className="flex-1 min-w-0">
                        <h3 className="font-semibold text-gray-900 dark:text-white midnight:text-cyan-50 purple:text-pink-50 mb-1">{option.label}</h3>
                        <p className="text-xs text-gray-500 dark:text-gray-400 midnight:text-cyan-300 purple:text-pink-300">{option.description}</p>
                      </div>
        ...
        {currentStep === "person" && (
          <div className="space-y-4">
            ...
            {isLoadingPeople ? (
              ...
              <div className="text-center py-12 border border-dashed border-gray-300 dark:border-gray-600 midnight:border-cyan-500/30 purple:border-pink-500/30 rounded-xl">
              ...
              <div className="max-h-[320px] overflow-y-auto border border-gray-200 dark:border-gray-700 midnight:border-cyan-500/20 purple:border-pink-500/20 rounded-xl divide-y divide-gray-100 dark:divide-gray-700">
                {filteredPeople.map((person) => (
                  ...
                  >
                    <div className="relative w-10 h-10 rounded-full overflow-hidden bg-gray-100 dark:bg-[#22262e] midnight:bg-[#0f1330] purple:bg-[#251340] flex-shrink-0">
                      <Image
                    ...
                    <div className="flex-1 min-w-0">
                      <p className="font-medium text-gray-900 dark:text-white midnight:text-cyan-50 purple:text-pink-50 text-sm truncate group-hover:text-purple-600 dark:group-hover:text-purple-400">
                        {person.name}
                      </p>
          ...
          <div className="space-y-6">
            ...
            {selectedPerson && (
              <div className="bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800 rounded-xl p-4">
                <div className="flex items-start gap-4">
                  <div className="relative w-14 h-14 rounded-full overflow-hidden bg-gray-100 dark:bg-[#22262e] midnight:bg-[#0f1330] purple:bg-[#251340] flex-shrink-0 ring-2 ring-white dark:ring-gray-700 midnight:ring-cyan-500/20 purple:ring-pink-500/20">
                    <Image
            ...
            {errors.class || errors.department || errors.expiryDate ? (
              <div className="flex items-start gap-3 p-4 bg-red-50 dark:bg-red-900/20 midnight:bg-red-900/20 purple:bg-red-900/20 border border-red-200 dark:border-red-800 rounded-xl">
                ...
                <div>
                  ...
                  <ul className="text-xs text-red-600 dark:text-red-400 midnight:text-red-400 purple:text-red-400 mt-1 list-disc list-inside">
              ...
              <div className="flex items-start gap-3 p-4 bg-blue-50 dark:bg-blue-900/20 midnight:bg-cyan-900/20 purple:bg-pink-900/20 border border-blue-200 dark:border-blue-800 rounded-xl">
                <CheckCircle2 className="w-5 h-5 text-blue-600 dark:text-blue-400 midnight:text-cyan-400 purple:text-pink-400 flex-shrink-0 mt-0.5" />
                <div>
                  <p className="text-sm font-semibold text-blue-700 dark:text-blue-300 midnight:text-cyan-300 purple:text-pink-300">Ready to add</p>
