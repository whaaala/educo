            ...
            {formData.reviewers.length === 0 ? (
              ...
              <div className="space-y-4">
                {formData.reviewers.map((reviewer, index) => (
                  <div key={index} className="p-4 bg-gray-50 dark:bg-gray-800/50 midnight:bg-gray-900/50 purple:bg-gray-900/50 rounded-lg border border-gray-200 dark:border-gray-700 midnight:border-cyan-500/20 purple:border-pink-500/20">
