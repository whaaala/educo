...
export default function ReceiptModal({
          ...
          return (
            <div key={step.id} className="flex items-center flex-1">
                ...
                <button
                  ...
                  className={`
                    ...
                    ${isCompleted
                      ...
                      : "bg-gray-100 dark:bg-[#1a1d24] midnight:bg-[#0f1330] purple:bg-[#251340] text-gray-400 dark:text-gray-500"
                    }
              ...
              {index < STEPS.length - 1 && (
                <div className="flex-1 mx-3 h-1 rounded-full bg-gray-200 dark:bg-[#22262e] overflow-hidden">
                  <div
                    className={`h-full rounded-full transition-all duration-500 ${
                      isCompleted
                        ? "bg-gradient-to-r from-green-500 to-emerald-500 w-full"
                        : "bg-gray-200 dark:bg-[#22262e] w-0"
                    }`}
                  />
                </div>
              )}
    ...
    <div className={`space-y-6 transition-all duration-300 ${animateStep ? "opacity-0 translate-x-4" : "opacity-100 translate-x-0"}`}>
      ...
      <div className="space-y-3">
        {formData.items.map((item, index) => (
          <div
            key={index}
            className="group relative p-4 bg-white dark:bg-[#1a1d24]/50 midnight:bg-[#0f1330]/50 purple:bg-[#251340]/50 rounded-xl border border-gray-200 dark:border-gray-700 hover:border-purple-300 dark:hover:border-purple-700 transition-all duration-200 hover:shadow-md animate-fadeIn"
            ...
            <button
              ...
              className={`
                ...
                ${formData.paymentMethod === method.value
                  ...
                  : "border-gray-200 dark:border-gray-700 hover:border-emerald-300 dark:hover:border-emerald-700 hover:bg-gray-50 dark:hover:bg-[#22262e]/50"
                }
              `}
            >
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        ...
        <div>
          ...
          <div className="relative flex items-center">
            <div className="flex-1 flex items-center gap-2 px-3.5 py-2.5 bg-gray-50 dark:bg-[#1a1d24] midnight:bg-[#0f1330]/50 purple:bg-[#251340]/50 border border-gray-200 dark:border-gray-700 rounded-lg">
            ...
            <div className="flex items-center gap-1 ml-2">
              ...
              <button
                ...
                className={`p-2 rounded-lg transition-all duration-200 ${
                  copiedReference
                    ...
                    : "bg-gray-100 dark:bg-[#22262e] text-gray-500 dark:text-gray-400 hover:bg-gray-200 dark:hover:bg-[#2a2d35] hover:text-gray-700 dark:hover:text-gray-300"
                }`}
              ...
              <button
                ...
                className="p-2 bg-gray-100 dark:bg-[#22262e] text-gray-500 dark:text-gray-400 hover:bg-blue-100 dark:hover:bg-blue-900/30 hover:text-blue-600 dark:hover:text-blue-400 rounded-lg transition-all duration-200"
  ...
  const renderReviewStep = () => (
    <div className={`space-y-6 transition-all duration-300 ${animateStep ? "opacity-0 translate-x-4" : "opacity-100 translate-x-0"}`}>
      ...
      {selectedSubjectOrCourse && (
        <div className="p-4 bg-white dark:bg-[#1a1d24] rounded-xl border border-gray-200 dark:border-gray-700">
