...
export default function BreakCard({
  ...
  return (
    <div className="bg-surface rounded-lg sm:rounded-xl border border-gray-200/60 dark:border-gray-700/60 midnight:border-cyan-500/20 purple:border-pink-500/20 p-3 sm:p-3.5 transition-all duration-200 hover:shadow-md hover:border-gray-300/80 dark:hover:border-gray-600/80 midnight:hover:border-cyan-500/30 purple:hover:border-pink-500/30">
      <div className="flex flex-col gap-2 sm:gap-2.5">
        {/* Label Badge */}
        <div className={`${styles.badgeBg} ${styles.badgeText} px-2.5 sm:px-3 py-1 sm:py-1.5 rounded-md sm:rounded-lg text-[0.6875rem] sm:text-xs font-bold w-fit`}>
          {label}
        </div>
        ...
        <div className="flex items-center gap-1.5 text-gray-700 dark:text-gray-300 midnight:text-cyan-300 purple:text-pink-300">
          ...
          <span className="text-xs sm:text-[0.8125rem] font-semibold leading-none whitespace-nowrap">
            {time}
          </span>
        </div>
      </div>
