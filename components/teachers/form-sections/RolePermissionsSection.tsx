  ...
  return (
    <section className="bg-surface rounded-xl border border-line shadow-sm hover:shadow-md transition-shadow duration-200">
      ...
      <button
        ...
        className="w-full bg-amber-50/50 dark:bg-amber-900/10 midnight:bg-amber-900/10 purple:bg-amber-900/10 hover:bg-amber-50 dark:hover:bg-amber-900/20 midnight:hover:bg-amber-900/20 purple:hover:bg-amber-900/20 px-6 py-3 flex items-center justify-between transition-all duration-200 border-b border-line"
      >
