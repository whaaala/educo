...
const getChannelColorClasses = (channel: string) => {
  switch (channel) {
    case "email": return { bg: "bg-blue-100 dark:bg-blue-900/30 midnight:bg-cyan-900/30 purple:bg-pink-900/30", text: "text-blue-600 dark:text-blue-400 midnight:text-cyan-400 purple:text-pink-400", label: "Email" };
        ...
        <div className="p-6">
          ...
          {isPlaceholder ? (
            <div className="p-4 rounded-xl bg-amber-50 dark:bg-amber-900/20 border border-amber-200 dark:border-amber-700 mb-4">
              <p className="text-sm text-amber-700 dark:text-amber-400 midnight:text-amber-400 purple:text-amber-400 text-center">
                This is a demo attachment. In a real application, the actual file content would be displayed here.
              </p>
            </div>
          ) : (
            <div className="p-4 rounded-xl bg-blue-50 dark:bg-blue-900/20 midnight:bg-cyan-900/20 purple:bg-pink-900/20 border border-blue-200 dark:border-blue-700 midnight:border-cyan-500 purple:border-pink-500 mb-4">
              <p className="text-sm text-blue-700 dark:text-blue-400 midnight:text-cyan-400 purple:text-pink-400 text-center">
          ...
          <div className="flex gap-3">
            <button
              type="button"
              onClick={onClose}
              className="flex-1 px-4 py-2.5 rounded-xl border border-gray-300 dark:border-gray-600 midnight:border-cyan-500/30 purple:border-pink-500/30 text-gray-700 dark:text-gray-300 midnight:text-cyan-200 purple:text-pink-200 font-medium hover:bg-gray-50 dark:hover:bg-[#22262e] midnight:hover:bg-cyan-500/10 purple:hover:bg-pink-500/10 transition-colors cursor-pointer"
            >
              Close
            </button>
            <button
          ...
          <div className="flex -space-x-1">
            {reminder.channels.map((channel, idx) => {
              ...
              return (
                <div
                  key={channel}
                  className={`w-8 h-8 rounded-lg ${config.bg} flex items-center justify-center border-2 border-white dark:border-[#1a1d24] midnight:border-cyan-500/10 purple:border-pink-500/10`}
                ...
                return (
                  ...
                  >
                    <div className="flex items-center gap-2 mb-2">
                      ...
                      <span className="text-xs font-semibold text-gray-700 dark:text-gray-300 midnight:text-cyan-200 purple:text-pink-200">
                        {config.label}
                      </span>
                    ...
                    <p className="text-sm text-gray-600 dark:text-gray-400 midnight:text-cyan-300 purple:text-pink-300 whitespace-pre-wrap">
                      {msg.message}
                    </p>
                      ...
                      <div className="mt-3 pt-3 border-t border-gray-200 dark:border-gray-700 midnight:border-cyan-500/20 purple:border-pink-500/20">
                        <div className="flex items-center justify-between mb-2">
                          ...
                          <button
                            type="button"
                            onClick={(e) => toggleAttachments(channel, e)}
                            className="p-1 rounded hover:bg-gray-200 dark:hover:bg-[#22262e] midnight:hover:bg-cyan-500/10 purple:hover:bg-pink-500/10 transition-colors cursor-pointer"
                          >
                        ...
                        <div className="space-y-2">
                          {effectiveAttachments.map((attachment) => (
                            <div
                              key={attachment.id}
                              className="flex items-center justify-between p-2.5 rounded-lg bg-white dark:bg-[#0f1115] midnight:bg-[#0a0e27] purple:bg-[#1a0b2e] border border-gray-200 dark:border-gray-600 midnight:border-cyan-500/30 purple:border-pink-500/30"
                            >
