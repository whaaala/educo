...
export default function FloatingTextToolbar({
  ...
  return (
    <div
      ref={toolbarRef}
      className="absolute z-[70] px-2 py-1.5 bg-surface border border-gray-300 dark:border-gray-600 midnight:border-cyan-500/30 purple:border-pink-500/30 rounded-xl shadow-xl shadow-black/15 dark:shadow-black/40 select-none"
      style={{
        left: elCenterX,
        top: topY,
