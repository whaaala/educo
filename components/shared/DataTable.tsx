...
export default function DataTable<T>({
 ...
 ? 'md:relative md:left-auto sticky left-0 z-40 bg-gray-50 dark:bg-[#22262e] midnight:bg-[#0f1330] purple:bg-[#251340]'
 : stickyColumnCount >= 2 && index === 1
 ? 'md:relative md:left-auto sticky left-[40px] sm:left-[48px] z-30 bg-gray-50 dark:bg-[#22262e] midnight:bg-[#0f1330] purple:bg-[#251340]'
 : '';
 ...
 return (
 <span key={pageNum} className="px-2 text-gray-400 dark:text-gray-500 midnight:text-cyan-400 purple:text-pink-400 font-bold">
 ...
 </span>
 );
 }
 ...
 ? "opacity-40 cursor-not-allowed text-gray-400 dark:text-gray-500 midnight:text-cyan-400 purple:text-pink-400"
 : currentPage === pageNum
 ...
 : "text-gray-600 dark:text-gray-400 midnight:text-cyan-400 purple:text-pink-400 hover:bg-gray-100 dark:hover:bg-[#22262e] midnight:hover:bg-cyan-500/10 purple:hover:bg-pink-500/10 hover:scale-105 active:scale-95 cursor-pointer"
 }`}
