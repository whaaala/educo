...
export default function ViewToggle({
  ...
  return (
    <div className={`relative flex items-center gap-0.5 p-0.5 rounded-lg border border-gray-300 dark:border-gray-600 midnight:border-cyan-500/30 purple:border-pink-500/30 bg-white dark:bg-gray-800 midnight:bg-gray-900 purple:bg-gray-900 shadow-sm isolate ${className}`}>
