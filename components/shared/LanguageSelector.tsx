  ...
  return (
    <div className="relative" ref={dropdownRef}>
      ...
      <button
        ...
        className="flex items-center gap-2 px-3 py-2 rounded-lg bg-white dark:bg-gray-800 midnight:bg-gray-900 purple:bg-gray-900 border border-gray-300 dark:border-gray-600 midnight:border-cyan-500/30 purple:border-pink-500/30 hover:border-gray-400 dark:hover:border-gray-500 transition-all duration-200 cursor-pointer"
      >
      ...
      {isOpen && (
        <div className="absolute top-full mt-2 left-0 min-w-[280px] bg-white dark:bg-gray-800 midnight:bg-gray-900 purple:bg-gray-900 rounded-xl shadow-2xl border border-gray-200 dark:border-gray-700 midnight:border-cyan-500/20 purple:border-pink-500/20 overflow-hidden z-[10000] animate-in fade-in slide-in-from-top-2 duration-200">
          {/* Header */}
          <div className="px-4 py-3 border-b border-gray-200 dark:border-gray-700 midnight:border-cyan-500/20 purple:border-pink-500/20 bg-gray-50 dark:bg-gray-750 midnight:bg-gray-800 purple:bg-gray-800">
          ...
          <div className="max-h-[320px] overflow-y-auto">
            {availableLanguages.map((language) => {
              ...
              return (
                ...
                >
                  {/* Language Icon */}
                  <div className="flex items-center justify-center w-8 h-8 rounded-full bg-white dark:bg-gray-800 midnight:bg-gray-900 purple:bg-gray-900 border border-gray-200 dark:border-gray-600 midnight:border-cyan-500/30 purple:border-pink-500/30 flex-shrink-0">
          ...
          {/* Footer Info */}
          <div className="px-4 py-2 border-t border-gray-200 dark:border-gray-700 midnight:border-cyan-500/20 purple:border-pink-500/20 bg-gray-50 dark:bg-gray-750 midnight:bg-gray-800 purple:bg-gray-800">
