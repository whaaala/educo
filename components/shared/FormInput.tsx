      ...
      <div className="group">
        ...
        <div className="relative" ref={calendarContainerRef}>
          ...
          <button
            ...
            disabled={disabled}
            className={`w-full h-[46px] pl-12 pr-10 py-2.5 rounded-xl border ${error ? "border-red-500 dark:border-red-400" : "border-gray-300 dark:border-gray-600 midnight:border-cyan-500/30 purple:border-pink-500/30"} bg-surface text-ink text-sm font-normal focus:ring-1 focus:ring-blue-500/10 dark:focus:ring-blue-400/10 midnight:focus:ring-cyan-500/10 purple:focus:ring-pink-500/10 focus:border-blue-500 dark:focus:border-blue-400 midnight:focus:border-cyan-500 purple:focus:border-pink-500 outline-none transition-all duration-200 hover:border-gray-400 dark:hover:border-gray-500 text-left cursor-pointer ${disabled ? "opacity-50 cursor-not-allowed" : ""}`}
