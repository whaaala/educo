      ...
      >
        ...
        <div className="bg-orange-50 dark:bg-orange-900/20 midnight:bg-orange-900/20 purple:bg-orange-900/20 px-6 pt-4 pb-3 rounded-t-2xl border-b border-orange-100 dark:border-orange-800/30 midnight:border-orange-700/30 purple:border-orange-700/30 flex-shrink-0">
          ...
          <p className="text-xs text-center text-gray-600 dark:text-gray-400 mt-1">
            Total Outstanding: <span className="font-semibold text-red-600 dark:text-red-400">{money(totalOutstanding)}</span>
          </p>
        </div>
            ...
            <div className="grid grid-cols-2 gap-3">
              ...
              >
                ...
                <div className="text-left">
                  ...
                  <p className="text-xs text-gray-500 dark:text-gray-400">Via email address</p>
                </div>
              </button>
              ...
              >
                ...
                <div className="text-left">
                  ...
                  <p className="text-xs text-gray-500 dark:text-gray-400">Via phone number</p>
                </div>
              </button>
              ...
              >
                ...
                <div className="text-left">
                  ...
                  <p className="text-xs text-gray-500 dark:text-gray-400">Mobile App</p>
                </div>
              </button>

              {/* WhatsApp Channel (placeholder - disabled) */}
              <div className="flex items-center gap-3 p-3 rounded-xl border-2 border-dashed border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-800/50 opacity-60">
                ...
                <div className="text-left">
                  <p className="text-sm font-medium text-gray-400 dark:text-gray-500">WhatsApp</p>
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    <p className="mt-2 text-xs text-gray-500 dark:text-gray-400">
                      Available placeholders: <code className="px-1 py-0.5 bg-gray-200 dark:bg-gray-600 rounded text-[10px]">{"{parentName}"}</code>{" "}
                      <code className="px-1 py-0.5 bg-gray-200 dark:bg-gray-600 rounded text-[10px]">{"{childName}"}</code>{" "}
                      <code className="px-1 py-0.5 bg-gray-200 dark:bg-gray-600 rounded text-[10px]">{"{feeType}"}</code>{" "}
                      <code className="px-1 py-0.5 bg-gray-200 dark:bg-gray-600 rounded text-[10px]">{"{balance}"}</code>{" "}
                      <code className="px-1 py-0.5 bg-gray-200 dark:bg-gray-600 rounded text-[10px]">{"{dueDate}"}</code>
                    </p>
                  </div>
                </div>
              )}
        ...
        {/* Footer */}
        <div className="px-6 pb-6 pt-4 flex items-center justify-end gap-3 border-t border-gray-200 dark:border-gray-700 flex-shrink-0 bg-white dark:bg-gray-800 rounded-b-2xl">
          <button
            onClick={onClose}
