...
export default function CustomDropdown({
  ...
  return (
    <div className={`relative ${className}`} ref={dropdownRef}>
      ...
      {/* Chevron Icon */}
      <ChevronRight className="absolute right-2 sm:right-3 top-1/2 -translate-y-1/2 w-3.5 h-3.5 sm:w-4 sm:h-4 text-gray-500 dark:text-gray-400 midnight:text-cyan-400 purple:text-pink-400 pointer-events-none rotate-90" />
