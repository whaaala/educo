            ...
            <div className="flex flex-wrap gap-2">
              ...
              {canReschedule && (
                <button
                  ...
                  className="flex items-center gap-2 px-4 py-2 text-sm font-semibold text-amber-700 dark:text-amber-300 bg-amber-100/80 dark:bg-amber-900/30 hover:bg-amber-200/80 dark:hover:bg-amber-900/50 rounded-xl transition-all hover:-translate-y-0.5"
                >
              ...
              {canCancel && (
                <button
                  ...
                  className="flex items-center gap-2 px-4 py-2 text-sm font-semibold text-red-700 dark:text-red-300 bg-red-100/80 dark:bg-red-900/30 hover:bg-red-200/80 dark:hover:bg-red-900/50 rounded-xl transition-all hover:-translate-y-0.5"
                >
              ...
              {canInviteParticipants && uninvitedParticipants.length > 0 && (
                <button
                  ...
                  className="flex items-center gap-2 px-4 py-2 text-sm font-semibold text-indigo-700 dark:text-indigo-300 bg-indigo-100/80 dark:bg-indigo-900/30 hover:bg-indigo-200/80 dark:hover:bg-indigo-900/50 rounded-xl transition-all hover:-translate-y-0.5"
                >
          ...
          <div className="rounded-2xl bg-gradient-to-br from-slate-50 to-slate-100/50 dark:from-slate-800/50 dark:to-slate-900/30 p-4 border border-slate-200/60 dark:border-slate-700/40 space-y-4">
            ...
            <div className="flex items-center justify-end gap-2 pt-2">
              ...
              <button
                ...
                className="flex items-center gap-2 px-4 py-2 text-sm font-semibold text-white bg-gradient-to-r from-red-500 to-red-600 hover:from-red-600 hover:to-red-700 rounded-xl shadow-lg shadow-red-500/25 transition-all disabled:opacity-50"
              >
                <Ban className="w-4 h-4" />
          ...
          <div className="rounded-2xl bg-gradient-to-br from-indigo-50 to-indigo-100/30 dark:from-indigo-900/20 dark:to-indigo-800/10 p-4 border border-indigo-200/60 dark:border-indigo-700/30 space-y-4">
            ...
            <div className="flex items-center justify-end gap-2 pt-2">
              ...
              <button
                ...
                className="flex items-center gap-2 px-4 py-2 text-sm font-semibold text-white bg-gradient-to-r from-indigo-500 to-indigo-600 hover:from-indigo-600 hover:to-indigo-700 rounded-xl shadow-lg shadow-indigo-500/25 transition-all disabled:opacity-50"
              >
                <UserPlus className="w-4 h-4" />
                Invite
              </button>
