...
export default function WeekNavigator({
    ...
    return (
      <div className={`flex items-center gap-2 ${className}`}>
        <button
          ...
          className="cursor-pointer p-1.5 rounded-md hover:bg-gray-100 dark:hover:bg-[#22262e] midnight:hover:bg-cyan-500/5 purple:hover:bg-pink-500/5 disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
  ...
  return (
    <div className={`flex flex-col sm:flex-row items-stretch sm:items-center gap-3 p-3 sm:p-4 bg-gray-50 dark:bg-[#1a1d24]/30 midnight:bg-[#0f1330]/30 purple:bg-[#251340]/30 rounded-lg border border-gray-200 dark:border-gray-700 midnight:border-cyan-500/20 purple:border-pink-500/20 ${className}`}>
      <div className="flex items-center gap-2 flex-1">
        <button
          onClick={onPreviousWeek}
          disabled={selectedWeek === 1}
          className="cursor-pointer p-2 rounded-lg bg-white dark:bg-[#1a1d24] midnight:bg-[#0a0e27] purple:bg-[#1a0b2e] border border-gray-300 dark:border-gray-600 midnight:border-cyan-500/30 purple:border-pink-500/30 hover:bg-gray-50 dark:hover:bg-[#22262e] midnight:hover:bg-cyan-500/5 purple:hover:bg-pink-500/5 disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
          aria-label="Previous week"
        >
