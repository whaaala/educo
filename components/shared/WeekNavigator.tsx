...
export default function WeekNavigator({
  ...
  return (
    <div className={`flex flex-col sm:flex-row items-stretch sm:items-center gap-3 p-3 sm:p-4 bg-gray-50 dark:bg-[#1a1d24]/30 midnight:bg-[#0f1330]/30 purple:bg-[#251340]/30 rounded-lg border border-line ${className}`}>
      <div className="flex items-center gap-2 flex-1">
        <button
          onClick={onPreviousWeek}
          disabled={selectedWeek === 1}
          className="cursor-pointer p-2 rounded-lg bg-surface border border-gray-300 dark:border-gray-600 midnight:border-cyan-500/30 purple:border-pink-500/30 hover:bg-gray-50 dark:hover:bg-[#22262e] midnight:hover:bg-cyan-500/5 purple:hover:bg-pink-500/5 disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
          aria-label="Previous week"
        >
