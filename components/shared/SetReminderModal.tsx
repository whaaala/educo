...
export default function SetReminderModal({
  ...
  const modalContent = (
    <div className="fixed inset-0 z-[9999] flex items-start justify-center bg-black/60 backdrop-blur-md pt-4 pb-4 px-4 sm:px-6 overflow-y-auto">
      <div
        ref={modalRef}
        className="relative w-full max-w-md bg-white dark:bg-gray-800 midnight:bg-gray-900 purple:bg-gray-900 rounded-xl sm:rounded-2xl shadow-2xl max-h-[calc(100vh-32px)] flex flex-col animate-in fade-in zoom-in duration-200 my-auto overflow-visible"
      >
        ...
        <div className="flex-1 overflow-y-auto overflow-x-visible px-4 sm:px-5 py-5">
          {isSuccess ? (
            <div className="flex flex-col items-center justify-center py-8">
              ...
              <h4 className="text-xl font-bold text-gray-900 dark:text-white mt-5 mb-1">
                Reminder Set!
              </h4>
            ...
            <div className="space-y-5">
              ...
              <div className="bg-gradient-to-br from-amber-50 to-orange-50 dark:from-amber-950/30 dark:to-orange-950/30 midnight:from-amber-950/30 midnight:to-orange-900/30 purple:from-amber-950/30 purple:to-orange-900/30 rounded-xl p-4 border border-amber-200/50 dark:border-amber-800/50">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="text-xs font-medium text-amber-700/70 dark:text-amber-400/70 uppercase tracking-wider">
                      Event Date
                    </p>
                      ...
                      <button
                        ...
                        className={`w-full flex items-center gap-3 p-3 rounded-xl border-2 transition-all duration-200 group ${
                          isSelected
                            ...
                            : "border-gray-100 dark:border-gray-700 hover:border-amber-200 dark:hover:border-amber-700/50 hover:bg-gray-50 dark:hover:bg-gray-700/30"
                        }`}
                      >
                        <div
              ...
              {selectedReminder === "custom" && (
                <div className="bg-gray-50 dark:bg-gray-700/30 rounded-xl p-4 border border-gray-200 dark:border-gray-600 animate-in slide-in-from-top-2 duration-200">
                  <p className="text-xs font-semibold text-gray-500 dark:text-gray-400 uppercase tracking-wider mb-3">
        ...
        {!isSuccess && (
          <div className="flex-shrink-0 px-4 sm:px-5 py-4 bg-gray-50 dark:bg-gray-800/50 midnight:bg-gray-800/50 purple:bg-gray-800/50 border-t border-gray-200 dark:border-gray-700 midnight:border-gray-700/30 purple:border-gray-700/30 rounded-b-xl sm:rounded-b-2xl">
            <div className="flex gap-3">
              <button
                type="button"
                onClick={onClose}
                className="flex-1 px-4 py-2.5 rounded-lg border border-gray-200 dark:border-gray-600 bg-white dark:bg-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600 text-gray-700 dark:text-gray-200 font-medium transition-all duration-200 active:scale-95 cursor-pointer"
              >
                Cancel
              </button>
              <button
