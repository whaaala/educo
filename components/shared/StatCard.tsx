...
export default function StatCard({
  ...
  const colorVariants: Record<StatCardColor, {
    ...
    blue: {
      ...
      iconBg: "bg-white dark:bg-[#1a1d24] midnight:bg-[#0a0e27] purple:bg-[#1a0b2e]/50 midnight:bg-[#0a0e27]/50 purple:bg-[#1a0b2e]/50",
  ...
  return (
    <div
      className={`
        ...
        border border-white/20 dark:border-gray-700 midnight:border-cyan-500/20 purple:border-pink-500/20/30
        backdrop-blur-sm
        overflow-hidden
        group
        h-[100px] sm:h-[110px]
