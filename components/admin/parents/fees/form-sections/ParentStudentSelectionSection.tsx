              ...
              <div className="group" data-field="parentId" ref={parentDropdownRef}>
                ...
                <div className="relative">
                  <button
                    ...
                    className={`appearance-none w-full min-h-[46px] text-sm font-normal bg-white dark:bg-gray-800 midnight:bg-gray-900 purple:bg-gray-900 ${
                      errors.parentId
                  ...
                  {isParentDropdownOpen && (
                    <div className="absolute z-50 w-full mt-1 bg-white dark:bg-gray-800 midnight:bg-gray-900 purple:bg-gray-900 rounded-xl border border-gray-200 dark:border-gray-700 shadow-xl max-h-80 overflow-hidden">
                      <div className="p-2 border-b border-gray-200 dark:border-gray-700">
                        <div className="relative">
                          ...
                          <input
                            ...
                            className="w-full pl-10 pr-4 py-2 rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500/20"
                            autoFocus
                          />
                        </div>
                      </div>
