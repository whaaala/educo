  ...
  return (
    <section className="bg-surface rounded-xl border border-line shadow-sm hover:shadow-md transition-shadow duration-200">
      ...
      <button
        ...
        className="w-full bg-emerald-50/50 dark:bg-emerald-900/10 midnight:bg-cyan-900/10 purple:bg-pink-900/10 hover:bg-emerald-50 dark:hover:bg-emerald-900/20 midnight:hover:bg-cyan-900/20 purple:hover:bg-pink-900/20 px-6 py-3 flex items-center justify-between transition-all duration-200 border-b border-line cursor-pointer"
      >
